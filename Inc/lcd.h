...
#define LED      6        //�����������        PB6
#define LCD_CS   5       //Ƭѡ����            PB5
#define LCD_RS   7       //�Ĵ���/����ѡ������ PB7 
#define LCD_RST  8       //��λ����            PB8


//QDtechȫϵ��ģ������������ܿ��Ʊ��������û�Ҳ���Խ�PWM���ڱ�������
#define LCD_LED_ON()  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET)
#define LCD_LED_OFF() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET)
...
//GPIO
#define LCD_CS_CLR  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET)
