 ...
 * @retvalue   :None
******************************************************************************/   	  
void LCD_ShowString(u16 x, u16 y, u16 fc, u16 bc, u8 size, u8 *p, u8 mode)
{         
    while((*p<='~')&&(*p>=' '))//�ж��ǲ��ǷǷ��ַ�!
    {   
 ...
 * @retval ��
 ****************************************************************************/
void LCD_ShowNum(u16 x, u16 y, u16 fc, u16 bc, double disnum, u8 zheng, u8 xiao, u8 size, u8 mode)
{
    u8 t, temp, len;
    u32 num;
    ...
    if(disnum < 0)
    {
        LCD_ShowChar(x, y, fc, bc, '-', size, mode); // ��ʾ����
        disnum = -disnum; // ת��Ϊ��������
        x = x + size/2; // ����X���꣬��������λ��
    }
...
/*****************************************************************************
 * @name       :void Gui_Drawbmp16_Custom(u16 x,u16 y,u16 width,u16 height,const unsigned char *p)
 * @date       :2024
 ...
 * @retvalue   :None
******************************************************************************/
void Gui_Drawbmp16_Custom(u16 x,u16 y,u16 width,u16 height,const unsigned char *p)
{
    int i;
    unsigned char picH,picL;
